...
interface TacoSearchAdvancedProps {
  onFoodSelect?: (food: AlimentoUnificado) => void
  showPagination?: boolean
}

export function TacoSearchAdvanced({ 
  onFoodSelect, 
  showPagination = true
}: TacoSearchAdvancedProps) {
  ...
  const [sourceFilter, setSourceFilter] = useState<'all' | 'TACO' | 'IBGE'>('all')
  ...
  const handleSearch = () => {
    ...
    const results = searchFoods(searchTerm, selectedCategory, sortBy, currentPage, sourceFilter)
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <Select value={sourceFilter} onValueChange={setSourceFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="TACO">📊 TACO (UNICAMP)</SelectItem>
                <SelectItem value="IBGE">🏛️ IBGE (POF)</SelectItem>
              </SelectContent>
            </Select>
          </div>
      ...
      <Card>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="space-y-3">
              {searchResults.foods.map((food: AlimentoUnificado) => (
                <div
                  key={food.id}
